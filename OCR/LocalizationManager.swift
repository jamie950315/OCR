...
class LocalizationManager: ObservableObject {
    ...
    private let translations: [String: [String: String]] = [
        ...
        "zh-CN": [
            ...
            "settings.api_key":            "OpenRouter API Key",
            "settings.model_id":           "模型 ID",
            "settings.model_hint":         "默认：google/gemini-2.5-pro-preview",
        ...
        "ja": [
            ...
            "settings.api_key":            "OpenRouter API Key",
            "settings.model_id":           "Model ID",
            "settings.model_hint":         "デフォルト: google/gemini-2.5-pro-preview",
        ...
        "ko": [
            ...
            "settings.api_key":            "OpenRouter API Key",
            "settings.model_id":           "Model ID",
            "settings.model_hint":         "기본값: google/gemini-2.5-pro-preview",
        ...
        "es": [
            ...
            "settings.api_key":            "OpenRouter API Key",
            "settings.model_id":           "Model ID",
            "settings.model_hint":         "Predeterminado: google/gemini-2.5-pro-preview",
        ...
        "fr": [
            ...
            "settings.api_key":            "OpenRouter API Key",
            "settings.model_id":           "Model ID",
            "settings.model_hint":         "Par défaut : google/gemini-2.5-pro-preview",
        ...
        "de": [
            ...
            "settings.api_key":            "OpenRouter API Key",
            "settings.model_id":           "Model ID",
            "settings.model_hint":         "Standard: google/gemini-2.5-pro-preview",
